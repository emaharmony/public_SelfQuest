...
public class DayNightManager : MonoBehaviour
{
    ...
    //Scene References
    [SerializeField] private Light DirectionalLight, extraSun, moon;
    [SerializeField] private LightingPreset Preset;
    //Variables
    [SerializeField, Range(0, 24)] private float TimeOfDay;

    [SerializeField] Material daySkyBox, nightSkyBox, sunsetBox, sunriseBox;
